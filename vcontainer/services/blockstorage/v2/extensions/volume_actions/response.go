...
func (s *ResizeResponse) ToResizeVolumeObject() *obj.ResizeVolume {
	return &obj.ResizeVolume{
		UUID:             s.Data.Uuid,
		Name:             s.Data.Name,
		Size:             s.Data.Size,
...
func (s *MappingResponse) ToMappingVolumeObject() *obj.MappingVolume {
	return &obj.MappingVolume{
		UUID: s.Uuid,
	}
}
